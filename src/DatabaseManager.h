...
~DatabaseManager();
    ...
    int updateContractProcurementCodeAndAmount(const std::string& number, const std::string& date, const std::string& procurement_code, bool has_contract_amount, double contract_amount);
